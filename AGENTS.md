...
| Rule File | Purpose |
|-----------|---------|
| `.Codex/rules/boot-context.md` | Read NEXT_STEPS.md and git log before working |
| `.Codex/rules/next-steps-tracking.md` | Update NEXT_STEPS.md at session end |
| `.Codex/rules/thor-development.md` | Feature pipeline: endpoint → model → client → view → CLI → test |
| `.Codex/rules/thorctl-skill.md` | **Full thorctl command reference + 50 agent endpoint map** — use this to control and debug devices |
